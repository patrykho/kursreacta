...
export const Modal = ({ dataToUpdate, toggleModal, updateTimebox }) => {
                    ...
                    <form onSubmit={handleSumbmit}>
                        <div className="field is-horizontal">
                            <div className="field-label is-normal">
                                ...
                                <div className="field">
                                    <p className="control">
                                        <input className="input is-rounded" defaultValue={title} ref={titleRef} type="text" placeholder="title" />
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="field is-horizontal">
                            <div className="field-label is-normal">
                                ...
                                <div className="field">
                                    <p className="control">
                                        <input className="input is-rounded" defaultValue={time} ref={timeRef} type="text" placeholder="time" />
                                    </p>
                                </div>
                            </div>
                        </div>
                        <button onSubmit={handleSumbmit} className="button is-success is-fullwidth">Save changes</button>
                    </form>
                </section>
